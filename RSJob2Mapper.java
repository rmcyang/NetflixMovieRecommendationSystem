 ...
 * Emit:
 * 		Key: item_id1	item_id2		Value: rating1  rating2 numRatings1  sumRatings1 numRatings2 sumRatings2
 * 		
 */
public class RSJob2Mapper extends Mapper<LongWritable, Text, Text, Text>{
